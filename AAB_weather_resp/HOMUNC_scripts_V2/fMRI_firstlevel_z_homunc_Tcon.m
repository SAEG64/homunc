...
% clear R
load([dir_base '/AAB_weather_resp/HOMUNC_scripts_v2/beh2fmri_homunc_v8.mat']);
...
%     blockNo = size( runs{ n_use }, 2); % i.e. sessions
    ...
    T.contrasts = {'forest_1','choice_b1','choice_b2','choice_b3','choice_g1','choice_g2','choice_g3','outcome_1','outcome_2'};
    contrasts = {'ons_overall','mod_overall', 'RT_overall', 'ons_b-g','mod_b-g','rt_b-g'};
