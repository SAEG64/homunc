...
load('/media/sergej/Extreme SSD/HOMUNC_parent/AAB_weather_resp/HOMUNC_scripts_v2/HOMUNC_data_beh_B_fMRI_v1.mat');
...
%     blockNo = Round{ n }.runs; % i.e. sessions
    ...
    clear  'Z'
    load(['/media/sergej/Extreme SSD/HOMUNC_parent/AAB_weather_resp/HOMUNC_scripts_V2/beh_prep/' fs filename_sub], 'Z');    
    ...
    for k = 1:blockNo
        ...
        ons_choice_W1 = [ons_choice_W1, Z.choice_1{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
        ons_choice_W2 = [ons_choice_W2, Z.choice_2{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
        
        RT_W1 = [RT_W1, log( Z.choice_1{k_use}(:,10)')];
        RT_W2 = [RT_W2, log( Z.choice_2{k_use}(:,10)')];

        % responses
        mod_W1 = [mod_W1, Z.choice_1{k_use}(:,11)'];
        mod_W2 = [mod_W2, Z.choice_2{k_use}(:,11)'];
    ...
    % normal state
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).name             = 'choice_b1';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).onset            = ons_choice_W1;
...
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).poly     = 1;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).name     = 'choice_b2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).param    = mod_W1; % reaction time
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(2).name     = 'choice_b3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(2).param    = RT_W1; % state posterior
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).name             = 'choice_g1';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).onset            = ons_choice_W2;
...
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).poly     = 1;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).name     = 'choice_g2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).param    = mod_W2; % reaction time
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).name     = 'choice_g3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).param    = RT_W2; % state posterior
    ...
    % outcome
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).name             = 'outcome_1';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).onset            = ons_outcome; % '<UNDEFINED>';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).duration         = 0;
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).tmod             = 0;
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(1).name     = 'outcome_2';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(1).param    = outcome; % diff '<UNDEFINED>';
