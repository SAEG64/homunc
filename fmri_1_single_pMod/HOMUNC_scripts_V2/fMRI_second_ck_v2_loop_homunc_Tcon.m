...
dir_base            = 'DIRECTORY TO FMRI DATA: HOMUNC_parent'; %'/projects/crunchie/korn/HOMUNC_kas';
dir_analysis_base   = 'HU_FMRI_USE'; % 'HOMUNC_ANALYSIS'; % 
dir_scripts         = 'FMRI_1_single_pMod/HOMUNC_scripts_v2';
...
contrastNames   = {'forest_1','choice_1','choice_2','choice_3','outcome_1','outcome_2'};
    
conImages       = {'con_0001.nii,1','con_0002.nii,1','con_0003.nii,1','con_0004.nii,1','con_0005.nii,1','con_0006.nii,1'};
