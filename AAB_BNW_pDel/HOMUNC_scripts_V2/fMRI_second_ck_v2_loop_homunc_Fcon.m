...
dir_scripts         = 'AAB_BNW_pDel/HOMUNC_scripts_v2';
...
contrastNames   = {'forest_1','choice_n_1','choice_n_2','choice_n_3','choice_w_1','choice_w_2','choice_w_3','choice_b_1','choice_b_2','choice_b_3','outcome_1','outcome_2','ons_overall','mod_overall','RT_overall','ons_interaction','mod_interaction','RT_interaction'};
    
conImages       = {'con_0001.nii,1','con_0002.nii,1','con_0003.nii,1','con_0004.nii,1','con_0005.nii,1','con_0006.nii,1','con_0007.nii,1','con_0008.nii,1','con_0009.nii,1','con_0010.nii,1','con_0011.nii,1','con_0012.nii,1','con_0013.nii,1','con_0014.nii,1','con_0015.nii,1','con_0016.nii,1','con_0017.nii,1','con_0018.nii,1','con_0019.nii,1','con_0020.nii,1','con_0021.nii,1'};
...
% one-way anovas
n_signle_con = 15; % enter the number of one-way contrast
nrun = n_signle_con;
...
% two-way anovas
nrun = (length(conImages)-n_signle_con)/2; % number of two-way interactions
jobfile = {[dir_base fs dir_scripts fs 'second_ck_v2_job_Fcon.m']};
jobs = repmat(jobfile, 1, nrun);
inputs = cell(2, nrun);
for crun = 1:nrun
    inputs{1, crun} = cellstr( con_dirs{ crun + n_signle_con }); % Factorial design specification: Directory - cfg_files
