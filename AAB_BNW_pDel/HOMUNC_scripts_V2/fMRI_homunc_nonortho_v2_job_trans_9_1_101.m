...
dirMRI_base       = 'HU_FMRI_USE'; % 'DATAMRI'; % 'HOMUNCMRI'; % 'DATA\FMRI';
...
load('/media/sergej/Extreme SSD/HOMUNC_parent/AAB_BNW_pDel/HOMUNC_scripts_v2/HOMUNC_data_beh_B_FMRI_v1.mat');
...
%     blockNo = Round{ n }.runs; % i.e. sessions
    ...
    clear  'Z'
    load(['/media/sergej/Extreme SSD/HOMUNC_parent/AAB_BNW_pDel/HOMUNC_scripts_V2/beh_prep/' fs filename_sub], 'Z');    
    ...
    for k = 1:blockNo
        ...
        %% Regressors
        onsorest = [onsorest, Z.forest{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
        
        ons_choice_B = [ons_choice_B, Z.choice_B{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
%         ons_choice_B_W = [ons_choice_B_W, Z.choice_B_W{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
        
        ons_choice_N = [ons_choice_N, Z.choice_N{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
%         ons_choice_N_W = [ons_choice_N_W, Z.choice_N_W{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
        
        ons_choice_W = [ons_choice_W, Z.choice_W{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
%         ons_choice_W_W = [ons_choice_W_W, Z.choice_W_W{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
        
        RT_B = [RT_B, log( Z.choice_B{k_use}(:,10)')];
        RT_N = [RT_N, log( Z.choice_N{k_use}(:,10)')];
        RT_W = [RT_W, log( Z.choice_W{k_use}(:,10)')];
        
%         RT_B_W = [RT_B_W, log( Z.choice_B_W{k_use}(:,10)')];
%         RT_N_W = [RT_N_W, log( Z.choice_N_W{k_use}(:,10)')];
%         RT_W_W = [RT_W_W, log( Z.choice_W_W{k_use}(:,10)')];
        
        mod_B = [mod_B, Z.choice_B{k_use}(:,61)'];
        mod_N = [mod_N, Z.choice_N{k_use}(:,61)'];
        mod_W = [mod_W, Z.choice_W{k_use}(:,61)'];
        
%         mod_B_W = [mod_B_W, Z.choice_B_W{k_use}(:,61)'];
%         mod_N_W = [mod_N_W, Z.choice_N_W{k_use}(:,61)'];
%         mod_W_W = [mod_W_W, Z.choice_W_W{k_use}(:,61)'];
        ...
        %% motion artefacts
        extension = 'txt';
        motionile = dir([epiDir fs '*.' extension]);
        motio     = textread([epiDir fs motionile.name]); 
        R = [R; motio];
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(1).onset            = onsorest;
    ...
    % normal state
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).name             = 'choice_n_1';
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).name     = 'choice_n_2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).param    = mod_N; % model
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(2).name     = 'choice_n_3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(2).param    = RT_N; % response time
...
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).name             = 'choice_n_W_1';
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).onset            = ons_choice_N_W;
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).duration         = 0;
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).tmod             = 0;
% 
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).name     = 'choice_n_W_2';
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).param    = mod_N_W; % model
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).poly     = 1;
%         
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).name     = 'choice_n_W_3';
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).param    = RT_N_W; % response time
...
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).orth             = ortho_yn;
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).name             = 'choice_w_1';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).onset            = ons_choice_W;
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).duration         = 0;
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).tmod             = 0;

        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).name     = 'choice_w_2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).param    = mod_W; % model
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).name     = 'choice_w_3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).param    = RT_W; % response time
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).poly     = 1;  

    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).orth             = ortho_yn;
    
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).name             = 'choice_w_W_1';
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).onset            = ons_choice_W_W;
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).duration         = 0;
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).tmod             = 0;
% 
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(1).name     = 'choice_w_W_2';
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(1).param    = mod_W_W; % model
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(1).poly     = 1;
%         
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(2).name     = 'choice_w_W_3';
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(2).param    = RT_W_W; % response time
...
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).orth             = ortho_yn;
    ...
    % binary energy state
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).name             = 'choice_b_1';
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(1).name     = 'choice_b_2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(1).param    = mod_B; % model
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(2).name     = 'choice_b_3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(2).param    = RT_B; % response time
...
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).name             = 'choice_b_W_1';
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).onset            = ons_choice_B_W;
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).duration         = 0;
%     matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).tmod             = 0;
% 
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(1).name     = 'choice_b_W_2';
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(1).param    = mod_B_W; % model
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(1).poly     = 1;
%         
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(2).name     = 'choice_b_W_3';
%         matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(2).param    = RT_B_W; % response time
