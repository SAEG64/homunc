...
%     blockNo = size( runs{ n_use }, 2); % i.e. sessions
    ...
    contrasts_FT = {'ons_overall','mod_overall','RT_overall','ons_main_ternary_1','ons_main_ternary_2','mod_main_ternary_1','mod_main_ternary_2','RT_main_ternary_1','RT_main_ternary_2'};
