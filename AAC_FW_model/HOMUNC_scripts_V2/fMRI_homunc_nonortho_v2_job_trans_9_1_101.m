...
load('/media/sergej/Extreme SSD/HOMUNC_parent/AAC_FW_model/HOMUNC_scripts_v2/HOMUNC_data_beh_B_fMRI_v1.mat');
...
%     blockNo = Round{ n }.runs; % i.e. sessions
    ...
    clear  'Z'
    load(['/media/sergej/Extreme SSD/HOMUNC_parent/AAC_FW_model/HOMUNC_scripts_V2/beh_prep/' fs filename_sub], 'Z');    
    ...
    for k = 1:blockNo
        ...
        ons_choice_0 = [ons_choice_0, Z.choice_0{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
        ons_choice_1 = [ons_choice_1, Z.choice_1{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
        
        RT_0 = [RT_0, log( Z.choice_0{k_use}(:,10)')];
        RT_1 = [RT_1, log( Z.choice_1{k_use}(:,10)')];
        
        % choice model
%         mod_0 = [mod_0, Z.choice_0{k_use}(:,62)'];
%         mod_1 = [mod_1, Z.choice_1{k_use}(:,62)'];
%         mod_0 = [mod_0, Z.choice_0{k_use}(:,14)'];
%         mod_1 = [mod_1, Z.choice_1{k_use}(:,14)'];
        mod_0 = [mod_0, (-1)*Z.choice_0{k_use}(:,62)'];
        mod_1 = [mod_1, (-1)*Z.choice_1{k_use}(:,62)'];
    ...
    % wait choices
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).name             = 'choice_w1';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).onset            = ons_choice_0;
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).param    = mod_0; % reaction time
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(2).name     = 'choice_w3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(2).param    = RT_0; % state posterior
    ...
    % foraging choices
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).name             = 'choice_f1';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).onset            = ons_choice_1;
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).param    = mod_1; % reaction time
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).name     = 'choice_f3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).param    = RT_1; % state posterior
