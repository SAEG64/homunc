...
% clear R
load([dir_base '/AAC_FW_model/HOMUNC_scripts_v2/beh2fmri_homunc_v8.mat']);
...
%     blockNo = size( runs{ n_use }, 2); % i.e. sessions
    ...
    T.contrasts = {'forest_1','choice_w1','choice_w2','choice_w3','choice_f1','choice_f2','choice_f3','outcome_1','outcome_2'};
    contrasts = {'ons_F-W','mod_F-W','lRT_F-W'};
