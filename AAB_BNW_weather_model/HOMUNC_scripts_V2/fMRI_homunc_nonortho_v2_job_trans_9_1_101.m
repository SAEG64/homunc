...
load('/media/sergej/Extreme SSD/HOMUNC_parent/AAB_BNW_weather_model/HOMUNC_scripts_v2/HOMUNC_data_beh_B_fMRI_v1.mat');
...
%     blockNo = Round{ n }.runs; % i.e. sessions
    ...
    clear  'Z'
    load(['/media/sergej/Extreme SSD/HOMUNC_parent/AAB_BNW_weather_model/HOMUNC_scripts_V2/beh_prep/' fs filename_sub], 'Z');    
...
%         ons_choice_W = [ons_choice_W, Z.choice_W{k_use}(:,1)' + sum(scans) * matlabbatch{1}.spm.stats.fmri_spec.timing.RT];
        ...
        mod_B_W1 = [mod_B_W1, Z.choice_B_W1{k_use}(:,14)'];
        mod_N_W1 = [mod_N_W1, Z.choice_N_W1{k_use}(:,14)'];
        mod_W_W1 = [mod_W_W1, Z.choice_W_W1{k_use}(:,14)'];
        
        mod_B_W2 = [mod_B_W2, Z.choice_B_W2{k_use}(:,14)'];
        mod_N_W2 = [mod_N_W2, Z.choice_N_W2{k_use}(:,14)'];
        mod_W_W2 = [mod_W_W2, Z.choice_W_W2{k_use}(:,14)'];
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).name     = 'choice_n_W1_2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).param    = mod_N_W1; % model
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(2).name     = 'choice_n_W1_3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(2).pmod(2).param    = RT_N_W1; % response time
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).name     = 'choice_n_W2_2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).param    = mod_N_W2; % model
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).name     = 'choice_n_W2_3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(3).pmod(2).param    = RT_N_W2; % response time
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(1).name     = 'choice_w_W1_2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(1).param    = mod_W_W1; % model
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(2).name     = 'choice_w_W1_3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(4).pmod(2).param    = RT_W_W1; % response time
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(1).name     = 'choice_w_W2_2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(1).param    = mod_W_W2; % model
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(2).name     = 'choice_w_W2_3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(5).pmod(2).param    = RT_W_W2; % response time
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(6).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(6).pmod(1).name     = 'choice_b_W1_2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(6).pmod(1).param    = mod_B_W1; % model
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(6).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(6).pmod(2).name     = 'choice_b_W1_3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(6).pmod(2).param    = RT_B_W1; % response time
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).tmod             = 0;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(1).name     = 'choice_b_W2_2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(1).param    = mod_B_W2; % model
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(1).poly     = 1;
        
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(2).name     = 'choice_b_W2_3';
        matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(7).pmod(2).param    = RT_B_W2; % response time
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(8).onset            = ons_outcome; % '<UNDEFINED>';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(8).duration         = 0;
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(8).tmod             = 0;
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(8).pmod(1).name     = 'outcome_2';
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond(8).pmod(1).param    = outcome; % diff '<UNDEFINED>';
