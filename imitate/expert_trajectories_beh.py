...
data['horizon'] = 5
# data['x32_p_foraging_gain'] = np.where(data['x7_weather_type'] == 1, 
#                           data['x19_weather_1_p_gain'],
#                           data['x20_weather_2_p_gain']).astype(np.float32)
# data.loc[data['x32_p_foraging_gain'] > 1, 'x32_p_foraging_gain'] = 0
...
for _, group in grouped:
    ...
    last_state = [
        ...
        group.iloc[-1]["x20_weather_2_p_gain"]] + list(
        list(categ.values())[:]) + [
        0,
