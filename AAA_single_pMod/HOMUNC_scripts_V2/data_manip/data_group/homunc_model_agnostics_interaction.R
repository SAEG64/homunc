...
load("/media/sergej/Extreme SSD/HOMUNC_parent/AAA_pMod_main/HOMUNC_scripts_V2/data_manip/data_group/homunc_Bayes_fit_res_threeVar_filtered_full_interaction.RData")
